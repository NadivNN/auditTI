...
class CobitItem extends Model
{
    ...
    {
        return $this->hasMany(Kategori::class); // Pastikan nama model Kategori benar
    }
    ...
    public function isCompletedByUser(User $user): bool
    {
        ...
        // Kita query ke tabel 'jawabans' melalui relasi yang ada di model User.
        $completedLevelIds = $user->jawabans() // Asumsi ada relasi 'jawabans()' di model User
