<x-app-layout>
    ...
    <section
        ...
        <div class="w-full max-w-screen-xl px-4 py-24 mx-auto text-center lg:py-56 z-10">
            <h1 class="mb-6 text-4xl font-extrabold leading-tight tracking-tight md:text-5xl lg:text-7xl
                       text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-cyan-300 to-purple-400
                       animate-fadeInDown drop-shadow-lg">
                Kami Mengoptimalkan Audit Proses TI untuk Masa Depan yang Lebih Aman
            </h1>
            <p class="mb-10 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48
            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0
                ...
                <a href="{{ route('audit.index') }}"
                   class="group relative inline-flex items-center justify-center px-6 py-3.5 text-base font-bold text-center text-white
                    ...
                    <span class="absolute top-0 left-0 w-0 h-full transition-all duration-500 ease-out A
                                   bg-white/20 group-hover:w-full opacity-50"></span>

                    <span class="relative">Get started</span> {{-- Teks harus relatif agar tetap di atas efek kilau --}}
                    <svg class="relative w-4 h-4 ms-2 rtl:rotate-180 transition-transform duration-300 group-hover:translate-x-1"
        ...
        {{-- <div class="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-slate-900 via-slate-900/80 to-transparent opacity-70 z-0"></div> --}}
        {{-- <div class="absolute top-10 -left-20 w-72 h-72 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse"></div> --}}
        {{-- <div class="absolute bottom-10 -right-20 w-72 h-72 bg-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse animation-delay-300"></div> --}}
